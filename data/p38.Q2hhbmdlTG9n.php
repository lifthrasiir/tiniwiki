<?php exit; ?>
Q2hhbmdlTG9n	38	YW5vbnltb3Vz	127.0.0.1	1081329148	
...
** 안에 td 태그를 HTML로 집어 넣을 경우 깨진다. 이 역시 고쳤다. -_-; (결국 \\x1E, \\x1F 추가... T_T)
*** 기존의 $`wikiHTMLblock 변수가 $`wikiHTMLblock(Inner|Outer)로 바뀌었다. config.php를 확인하기 바란다. -_-;

<?php exit; ?>
VGluaVdpa2lHb2Fs	4	YW5vbnltb3Vz	219.248.202.19	1079244953	
! TiniWiki의 목표
...
그런 데서 본받을 만한 프로그램은 블로그 프로그램인 Tatter tools이다. 이건 아예 문서 자체가 별로 필요하지 않을 정도로 사용자가 사용하기에 그리 어렵지 않은 프로그램이다. ("태터 툴즈 따라하기"라는 제목의 강좌가 한 여덟 편 올라 왔는데 그것 가지고도 웬만한 건 다 쓸 수 있을 거라고 생각될 정도이다.) 꽤 잘 만든 프로그램이라고 생각되는데 나도 그렇게 만들 수 있으면 좋겠다. :) ''(태터 툴즈의 거의 유일한 단점은 출력 결과가 전혀 XHTML 혹은 HTML 4.01 Transitional 등과 동떨어진 형태라는 것이다. -_-)''
// 실제로, 태터 툴즈 홈페이지엘 보면 header라는 알 수 없는 태그(사실은 head지... -_-)를 볼 수 있다. 그 어렵지도 않은 HTML 4.01 Transitional조차 200여개 틀린 걸 보면 -_-;
...
!!! 다른 위키에서 지원하는 내용 중 많이 쓰일 만한 건 어떻게든 지원한다.

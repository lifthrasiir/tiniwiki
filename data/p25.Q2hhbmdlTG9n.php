<?php exit; ?>
Q2hhbmdlTG9n	25	YW5vbnltb3Vz	127.0.0.1	1079109685	
...
* heading과 hr 태그 등등의 몇몇 처리와 목록 파싱 부분이 syntax_linear 함수로 통합. 이 부분은 전체 줄 수만큼 루프를 돌며, 불필요한 preg 문이 없으므로 속도가 훨씬 더 빠르다. (고 예상된다.) ''아직 pre 태그에 대한 처리가 없다.''
...
!!! version 0.1.-300 ''(2003/02/26 - 2003/02/28)''
* 개발 시작. 뼈대만 붙여 놓고 있다.

! tokiWiki version 0.0 ''(2002/10/17)''
* TiniWiki의 전신이 되는 프로그램으로, MySQL을 사용하는 위키 프로그램.
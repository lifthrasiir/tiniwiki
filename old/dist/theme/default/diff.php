...
<? if($version0 < $cversion && $version1 < $cversion) { ?>
	<a href="<?=$wikiPath?>/<?=$PAGE?>?diff=<?=$version0+1?>,<?=$version1+1?>" class="_noline">&lt;</a>
<? } ?>
	<a href="<?=$wikiPath?>/<?=$PAGE?>?view=<?=$version0?>" class="_noline">v<?=$version0?></a> - 
	<a href="<?=$wikiPath?>/<?=$PAGE?>?view=<?=$version1?>" class="_noline">v<?=$version1?></a>
